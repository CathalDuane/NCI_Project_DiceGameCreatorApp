...
function myFunction(selectTag) {
    ...
    document.getElementById("result").style.fontFamily = listValue;
    document.getElementById("history").style.fontFamily = listValue;
  }
...
function changeSizeBySlider() {
    var slider = document.getElementById("history");
